...
#    Updated: 2021/05/13 10:29:42 by jdaufin          ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
SRC_NAME = ft_atoi.c ft_memdel.c ft_strcat.c ft_strncat.c ft_bzero.c\
		   ...
		   ft_printf.c get_queue.c mappers.c process_fmt.c\
		   converters_decimals.c converters_unsigned.c converters_octal.c converters_hex.c\
...
$(OBJDIR)%.o : $(SRCDIR)%.c $(HDR)
	...
	&& printf "$< : \e[32mOK\e[0m%-32s \r" "" \
	|| printf "$< \e[31KO\e[0m%-32s \r" ""
